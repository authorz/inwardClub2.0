...
import { CollectionCodeDialog } from '@/components/common'
...
const channelLabels = COLLECTION_PAY_CHANNELS.map((channel) => PAY_CHANNEL[channel].label).join(' / ')
</script>
...
<template>
  <NForm label-placement="top">
    ...
    <p class="collection-create__hint ic-muted">
